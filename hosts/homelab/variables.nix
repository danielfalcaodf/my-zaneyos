{
  ...
  gitUsername = "danielfalcaodf";
  gitEmail = "danielfalcao.df@gmail.com";
  ...
  # Enable lan-mouse for sharing mouse and keyboard with other PCs over LAN
  # Web UI available at http://localhost:4242 after rebuild
  lanMouseEnable = true;
