            ...
            case "$pkg_subcommand" in
              scaffold)
                ...
                [[ -n "$GITHUB_URL" ]] || {
                  ...
                  echo "Uso: zcli pkg scaffold <github-url>" >&2
                  echo "Exemplo: zcli pkg scaffold https://github.com/owner/repo" >&2
                  exit 1
                }
                ...
                echo "  Nome        : $PKG_NAME"
                echo "  Destino     : $PKG_DIR/default.nix"
                echo ""

                ensure_pkgs_dir
                mkdir -p "$PKG_DIR"

                echo "ℹ  Iniciando nix-init (pode ser interativo)..."
                echo ""
              ...
              list)
                echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                echo "  📦  Pacotes customizados em ~/zaneyos/pkgs/"
                echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                if [[ ! -d "$PKGS_DIR" ]]; then
